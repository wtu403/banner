 ...
 * 指示器
 */
public class DrawableIndicatorView extends View {
    ...
    public DrawableIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DrawableIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
